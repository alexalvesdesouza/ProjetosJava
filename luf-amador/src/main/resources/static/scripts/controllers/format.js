angular.module("app.directive.format", [])
.directive('formatApp', ['$filter',
	  function($filter) {
	    return {
	      require: '?ngModel',
...
/*
 * Referência para formatador do campo de imputmoney
 * https://pt.stackoverflow.com/questions/2899/problema-em-m%C3%A1scara-de-moeda-em-input
 * http://plnkr.co/edit/nvhQ1cb74kns1didAaZ8?p=preview
 * 
 */
(function($) {
